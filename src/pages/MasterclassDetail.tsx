          ...
          <FadeInSection>
            <div className="relative rounded-2xl overflow-visible" style={{ background: "linear-gradient(135deg, hsl(24 95% 53%) 0%, hsl(30 90% 55%) 50%, hsl(38 95% 55%) 100%)" }}>
              <div className="relative flex flex-col md:flex-row items-end">
                ...
                <div className="hidden md:block w-[340px] lg:w-[420px] shrink-0 relative overflow-visible">
                  <img
                    src={gvrSittingImg}
                    alt={data.name}
                    className="w-full h-auto object-contain drop-shadow-2xl absolute bottom-0 right-0"
                    style={{ transform: 'translateY(0) scale(1.3)', transformOrigin: 'bottom center' }}
                    loading="lazy"
                  />
                </div>
              </div>
