...
const tocSections = [
  ...
  { id: "access-use", label: "2. Access and Use of the Service" },
  { id: "conditions", label: "3. Conditions of Use" },
  { id: "fees", label: "4. Fees" },
  { id: "subscriptions", label: "5. Recurring Subscriptions" },
  { id: "international", label: "6. Special Notice for International Use" },
  { id: "commercial", label: "7. Commercial Use" },
  { id: "ip-rights", label: "8. Intellectual Property Rights" },
  { id: "third-party", label: "9. Third Party Websites" },
  { id: "social", label: "10. Social Networking Services" },
  { id: "indemnity", label: "11. Indemnity and Release" },
  { id: "disclaimer", label: "12. Disclaimer of Warranties" },
  { id: "liability", label: "13. Limitation of Liability" },
  { id: "arbitration", label: "14. Binding Arbitration; Class Action Waiver" },
  { id: "termination", label: "15. Termination" },
  { id: "disputes", label: "16. Disputes between Users" },
  { id: "general", label: "17. General" },
  { id: "contact", label: "18. Questions? Concerns? Suggestions?" },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20 md:py-28">
        ...
        <div className="space-y-0 font-sans-body text-sm md:text-base text-muted-foreground leading-relaxed">
          ...
          <section id="welcome" className="border-b border-border pb-8 mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-3">1. Welcome to Level Up Learning!</h2>
            <h3 className="text-lg font-medium text-foreground mb-2">Introduction</h3>
            <p>Level Up Learning provides its services (described below) to you through its website located at www.leveluplearning.in (the "Site") and through its mobile applications and related services (collectively, such services, including any new features and applications, and the Site, the "Service(s)"), subject to the following Terms of Service (as amended from time to time, the "Terms of Service").</p>
            <div className="bg-muted/50 border-l-2 border-primary p-4 rounded mt-4">
              <p className="font-medium text-foreground text-sm">PLEASE READ THESE TERMS OF SERVICE CAREFULLY, AS THEY GOVERN YOUR USE OF THE SITE AND SERVICES, PARTICULARLY SECTION 14 (BINDING ARBITRATION; CLASS ACTION WAIVER), WHICH AFFECTS YOUR RIGHTS IN THE EVENT OF A DISPUTE BETWEEN US.</p>
            </div>

            <h3 className="text-lg font-medium text-foreground mt-6 mb-2">Modifications to Terms of Service</h3>
          ...
          <section id="conditions" className="border-b border-border pb-8 mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-3">3. Conditions of Use</h2>
            <h3 className="text-lg font-medium text-foreground mb-2">User Conduct</h3>
            ...
            <ul className="list-disc pl-6 mt-3 space-y-2">
              ...
              <li>Violate any applicable local, state, national or international law, or any regulation having the force of law;</li>
          ...
          <section id="subscriptions" className="border-b border-border pb-8 mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-3">5. Recurring Subscriptions</h2>
            <p>If you select a Service with an auto renewal feature ("Recurring Subscription"), you authorize Level Up Learning to maintain your account information and charge that account automatically upon the renewal of the Service you choose with no further action required by you. In the event that Level Up Learning is unable to charge your account as authorized by you when you enrolled in a Recurring Subscription, Level Up Learning may, in its sole discretion: (i) bill you for your Service and suspend your access to the Service until payment is received, and/or (ii) seek to update your account information through third party sources (i.e., your bank or a payment processor) to continue charging your account as authorized by you.</p>
          </section>

          <section id="international" className="border-b border-border pb-8 mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-3">6. Special Notice for International Use; Export Controls</h2>
            <p>Software (defined below) available in connection with the Service and the transmission of applicable data, if any, is subject to United States export controls. No Software may be downloaded from the Service or otherwise exported or re-exported in violation of Indian export laws. Downloading or using the Software is at your sole risk. Recognizing the global nature of the Internet, you agree to comply with all local rules and laws regarding your use of the Service, including as it concerns online conduct and acceptable content.</p>
          </section>

          <section id="commercial" className="border-b border-border pb-8 mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-3">7. Commercial Use</h2>
          ...
          <section id="ip-rights" className="border-b border-border pb-8 mb-8">
            ...
            <h3 className="text-lg font-medium text-foreground mt-6 mb-2">8.4 Copyright Complaints</h3>
            <p>Level Up Learning respects the intellectual property of others, and we ask our users to do the same. If you believe that your work has been copied in a way that constitutes copyright infringement, or that your intellectual property rights have been otherwise violated, you should notify Level Up Learning of your infringement claim in accordance with the procedure set forth below.</p>
            <p className="mt-3">You may also contact us by mail or facsimile at: <a href="mailto:support@leveluplearning.in" className="text-primary hover:underline">support@leveluplearning.in</a></p>
            <p className="mt-2">Address: LEVEL UP EDU PVT.LTD - Old no.9 New, no.17, Seethammal Rd, Seethammal Colony, Alwarpet, Chennai, Tamil Nadu 600018</p>

            <h3 className="text-lg font-medium text-foreground mt-6 mb-2">8.5 Counter-Notice</h3>
            <p>If you believe that your User Content that was removed (or to which access was disabled) is not infringing, or that you have the authorization from the copyright owner, the copyright owner's agent, or pursuant to the law, to upload and use the content in your User Content, you may send a written counter-notice containing the following information to the Copyright Agent: your physical or electronic signature; identification of the content that has been removed or to which access has been disabled and the location at which the content appeared before it was removed or disabled; a statement that you have a good faith belief that the content was removed or disabled as a result of mistake or a misidentification of the content; and your name, address, telephone number, and email address, a statement that you consent to the jurisdiction of the Courts of Tamil Nadu and a statement that you will accept service of process from the person who provided notification of the alleged infringement.</p>

            <h3 className="text-lg font-medium text-foreground mt-6 mb-2">8.6 Repeat Infringer Policy</h3>
            <p>Level Up Learning has adopted a policy of terminating, in appropriate circumstances and at Level Up Learning's sole discretion, users who are deemed to be repeat infringers. Level Up Learning may also at its sole discretion limit access to the Service and/or terminate the memberships of any users who infringe any intellectual property rights of others, whether or not there is any repeat infringement.</p>
          </section>

          <section id="third-party" className="border-b border-border pb-8 mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-3">9. Third Party Websites</h2>
            <p>The Service may provide, or third parties may provide, links or other access to other sites and resources on the Internet. Level Up Learning has no control over such sites and resources and Level Up Learning is not responsible for and does not endorse such sites and resources. You further acknowledge and agree that Level Up Learning will not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any content, events, goods or services available on or through any such site or resource. Any dealings you have with third parties found while using the Service are between you and the third party, and you agree that Level Up Learning is not liable for any loss or claim that you may have against any such third party.</p>
          </section>

          <section id="social" className="border-b border-border pb-8 mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-3">10. Social Networking Services</h2>
            <p>You may enable or log in to the Service via various online third party services, such as social media and social networking services like Facebook ("Social Networking Services"). By logging in or directly integrating these Social Networking Services into the Service, we make your online experiences richer and more personalized. To take advantage of this feature and capabilities, we may ask you to authenticate, register for or log into Social Networking Services on the websites of their respective providers. As part of such integration, the Social Networking Services will provide us with access to certain information that you have provided to such Social Networking Services, and we will use, store and disclose such information in accordance with our Privacy Policy. For more information about the implications of activating these Social Networking Services and Level Up Learning's use, storage and disclosure of information related to you and your use of such services within Level Up Learning (including your friend lists and the like), please see our Privacy Policy. However, please remember that the manner in which Social Networking Services use, store and disclose your information is governed solely by the policies of such third parties, and Level Up Learning shall have no liability or responsibility for the privacy practices or other actions of any third party site or service that may be enabled within the Service. In addition, Level Up Learning is not responsible for the accuracy, availability or reliability of any information, content, goods, data, opinions, advice or statements made available in connection with Social Networking Services. As such, Level Up Learning is not liable for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such Social Networking Services. Level Up Learning enables these features merely as a convenience and the integration or inclusion of such features does not imply an endorsement or recommendation.</p>
          </section>

          <section id="indemnity" className="border-b border-border pb-8 mb-8">
            <h2 className="text-xl font-semibold text-foreground mb-3">11. Indemnity and Release</h2>
            <p>You agree to release, indemnify and hold Level Up Learning and its affiliates and their officers, employees, directors and agents harmless from any and all losses, damages, expenses, including reasonable attorneys' fees, rights, claims, actions of any kind and injury (including death) arising out of or relating to your use of the Service, any User Content, your connection to the Service, your violation of these Terms of Service or your violation of any rights of another.</p>
          </section>

          <section id="disclaimer" className="border-b border-border pb-8 mb-8">
