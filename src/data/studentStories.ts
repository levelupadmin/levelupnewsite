...
export const studentStories: StudentStory[] = [
  {
    ...
    seoTitle: "Construction Worker to Filmmaker: Akhil | LevelUp Review",
    metaDescription: "Akhil Billy Varghese went from Kerala construction sites to film direction via LevelUp's online Filmmaking Workshop.",
  ...
  },
  {
    ...
    seoTitle: "Rithu's Gap Year for Filmmaking | LevelUp Workshop Review",
    metaDescription: "Rithu Nanda scored 92% in boards but took a gap year to explore filmmaking, finding her calling at LevelUp's Filmmaking Workshop.",
  ...
  },
  {
    ...
    seoTitle: "Debajit's Creative Comeback | LevelUp Screenwriting Review",
    metaDescription: "Business exec Debajit Dutta abandoned creative work for 4 years. LevelUp's Screenwriting Workshop reignited his storytelling passion.",
  ...
  },
  {
    ...
    seoTitle: "Ankur's Screenwriting Story | LevelUp Workshop Review",
    metaDescription: "IT pro Ankur Paliwal watched cinema for years but never told his stories. LevelUp's Screenwriting Workshop gave him the tools to begin.",
  ...
  },
  {
    ...
    seoTitle: "'A Film By Suryansh' | LevelUp Filmmaking Workshop Review",
    metaDescription: "Delhi University student Suryansh dreams of seeing his name on the big screen. LevelUp's Filmmaking Workshop brought him closer.",
  ...
  },
  {
    ...
    seoTitle: "MBBS Student's Cinema Dream | Swathi's LevelUp Review",
    metaDescription: "MBBS student Swathi Muthu has dreamed of cinema since childhood. LevelUp's Screenwriting Workshop became her first step from medicine to movies.",
  ...
  },
  {
    ...
    seoTitle: "Beginner to Filmmaker in 8 Days | Gagandeep's Forge Review",
    metaDescription: "Gagandeep Singh Bhatia had never held a camera. After 8 days at LevelUp's Forge filmmaking program, he made his own short film.",
  ...
  },
  {
    ...
    seoTitle: "Raghav: BFP Beat Film School in 5 Days | LevelUp Review",
    metaDescription: "Chennai film school student Raghav Nikhil, now directing a feature, says LevelUp's BFP surpassed his entire year of formal film education.",
  ...
  },
  {
    ...
    seoTitle: "Doctor Learns Photography | Dr. Kanchana's LevelUp Review",
    metaDescription: "Dr. Kanchana understood the human body but never her camera. LevelUp's Photography Workshop gave her confidence to see through a lens.",
  ...
  },
  {
    ...
    seoTitle: "Aswathy's Story Journey | LevelUp Screenwriting Review",
    metaDescription: "BCom grad Aswathy S lost her creative voice in formal education. LevelUp's Screenwriting Workshop helped her rediscover her storytelling gift.",
  ...
  },
  {
    ...
    seoTitle: "Entrepreneur's Forge Breakthrough | LevelUp Review",
    metaDescription: "Freelancer Deshpande Akhil attended LevelUp's Forge and learned storytelling is about honesty, not approval. An immersive mindset shift.",
  ...
  },
  {
    ...
    seoTitle: "Filmmaking Without Quitting My Job | Sudhan's BFP Review",
    metaDescription: "Sudhan's parents refused to let him quit for a film diploma. LevelUp's BFP gave him everything in 5 days without sacrificing his livelihood.",
  ...
  },
  {
    ...
    seoTitle: "Shy Student Transformed at Forge | Ujwal's LevelUp Review",
    metaDescription: "K. Ujwal was too shy to talk on Day 1 of Forge. By Day 8, he had lifelong friends and a new perspective from LevelUp's filmmaking program.",
  ...
  },
  {
    ...
    seoTitle: "Hogwarts for Writers | Abhinav's LevelUp Forge Review",
    metaDescription: "Ecommerce entrepreneur and aspiring screenwriter Abhinav Bainslay calls LevelUp's Forge Writing cohort 'Hogwarts for writers.'",
  ...
  },
  {
    ...
    seoTitle: "Teacher Learns Storytelling | Shadabul's LevelUp Review",
    metaDescription: "School teacher Shadabul Haque tells stories to children daily but never learned the craft. LevelUp's Screenwriting Workshop taught him the science.",
  ...
  },
  {
    ...
    seoTitle: "Skeptic CAD Designer Becomes Screenwriter | LevelUp Review",
    metaDescription: "Saleem Mohammed, a CAD designer at an MNC, doubted a short course could make him a screenwriter. LevelUp's Screenwriting Mastery proved him wrong.",
  ...
  },
  {
    ...
    seoTitle: "Doctor's Debut Film Wins 110 Awards | LevelUp Filmmaking",
    metaDescription: "Dr. C Raja Ravi Varma attended LevelUp's Filmmaking, Screenwriting & Editing Workshops, then made his debut Murugesanum Cellphonum — winning 110 awards.",
  ...
  },
  {
    ...
    seoTitle: "Ashok Writes His Story | LevelUp Screenwriting Review",
    metaDescription: "Semi-retired D Ashok Kumar carried a love story for 3 years but couldn't write it. One LevelUp Screenwriting Workshop broke the block.",
