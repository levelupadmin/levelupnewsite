...
const data: MasterclassPageData = {
  ...
  valueProps: [
    {
      ...
      description: "This masterclass is invaluable as it offers a captivating insight into the intricacies and nuances of filmmaking, allowing for a fresh and inspiring perspective.",
  ...
  testimonials: [
    {
      ...
      quote: "Anthony Gonsalvez's online editing class was an eye-opener! Watching a seasoned professional at work, explaining his every move, was invaluable. His approach blends artistry with technical finesse seamlessly. I feel equipped with the skills to edit like a pro now!",
    },
    {
      name: "Shalini",
      role: "Theater Artist",
      image: testimonialShalini,
      quote: "As a budding filmmaker, I couldn't have asked for a better mentor than Anthony Gonsalvez. His class was a masterclass in itself! The way he effortlessly maneuvered through the editing process, demystifying complexities, left me inspired and confident. This course is a game-changer!",
    },
    {
      name: "Jagadeesh",
      role: "Director",
      image: testimonialJagadeesh,
      quote: "Anthony Gonsalvez's course exceeded my expectations. His hands-on approach to teaching editing, along with the insights he shared, made it an unparalleled learning experience. I now approach editing with a newfound perspective, thanks to his expert guidance.",
    },
  ],
  benefits: [
  ...
  studentCount: "1800+",
  faqs: [
    { question: "Who is this class for?", answer: "This class is for anyone who has an interest in editing videos, short and feature films. This class acts as a guide for an aspiring editor to navigate the difficulties and intricacies of editing along with Tips and Tricks on how to go about the process in general." },
    { question: "I'm an Intermediate/Professional Editor, would I benefit from this?", answer: "Yes. In the course Anthony Gonsalvez breaks down his process of editing and walks you through how he edits a scene with the footage provided." },
    { question: "What do I need to learn from this class?", answer: "The only prerequisite that you require for this class is the Passion to learn. You do not need any prior knowledge of editing. Oh, and you definitely do need a Device with an Internet connection and a few hours to spare!" },
    { question: "Will Anthony Gonsalvez be teaching the Class?", answer: "Yes, Anthony Gonsalvez will be teaching all the lessons in the Class. However, the lessons will be recorded & will not have or involve any live sessions/interactions." },
    { question: "Which Language is the course in?", answer: "This course is in English with English Subtitles." },
    { question: "Are there any recurring costs that I need to pay to access the videos?", answer: "There are no recurring costs or any additional charge that you need to pay after purchasing the Learning experience." },
    { question: "How long is the Class?", answer: "The Class is approximately 240 minutes long and is divided into 19 Video Lessons." },
    { question: "When do I get to download the customised signed certificate?", answer: "You get to access the certificate once you complete watching all the lessons in the course." },
    { question: "Where can I watch these classes?", answer: "You can access LevelUp Learning across various devices - Mobiles, Tablets, Desktops or Laptops. You can access classes on mobile by downloading the LevelUp Learning App for Android and iOS devices." },
  ],
  price: 1999,
  originalPrice: 7999,
  currency: "₹",
  ...
  seo: {
    ...
    description: "Learn film editing from Anthony Gonsalvez — Award-winning Film Editor. Master editing techniques, transitions, pacing and more in this hands-on practical masterclass.",
  },
};
