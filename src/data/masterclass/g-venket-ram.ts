...
const data: MasterclassPageData = {
  ...
  studentCount: "1800+",
  faqs: [
    { question: "Who is this class for?", answer: "This class acts as a guide for an aspiring photographer." },
    { question: "I'm an Intermediate/Professional Photographer, would I benefit from this?", answer: "In this course, Venket Ram shares his professional experiences as a photographer, rather than teach a photography course with established guidelines and instructions. He believes that this is a better way to understand photography concepts, so that you can build your own style and perspective, using his processes as inspiration." },
    { question: "What do I need to learn from this class?", answer: "The only prerequisite that you require for this class is the Passion to learn. You do not need any prior knowledge of photography. Oh, and you definitely do need a Device with an Internet connection and a few hours to spare!" },
    { question: "Will G. Venket Ram be teaching the Class?", answer: "Yes, G. Venket Ram will be teaching all the lessons in the Class. However, the lessons will be recorded & will not have or involve any live sessions/interactions." },
    { question: "Which Language is the course in?", answer: "This course is in Tamil and English with English Subtitles." },
    ...
    { question: "How long is the Class?", answer: "The Class is approximately 190 minutes long and is divided into 25 Video Lessons." },
    ...
    { question: "Where can I watch these classes?", answer: "You can access classes on mobile by downloading the LevelUp Learning App for Android and iOS devices." },
  ],
  price: 2499,
  originalPrice: 2999,
  currency: "₹",
  ...
  seo: {
    ...
    description: "Learn photography from G Venket Ram — India's most celebrated portrait photographer. Master lighting, composition, post-processing and more in this in-depth masterclass.",
  },
};
