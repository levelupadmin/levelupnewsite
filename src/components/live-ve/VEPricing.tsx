  ...
  <section className="py-20 md:py-28" style={{ background: "hsl(160 8% 8%)" }}>
    <div className="max-w-xl mx-auto px-6 md:px-12">
      <FadeInSection className="text-center mb-10">
        <p className="text-xs text-white/40 tracking-[0.2em] uppercase mb-4">🎬 Fee</p>
      ...
      <FadeInSection delay={100}>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 mb-4">
          <p className="text-purple-400 text-sm font-medium mb-1">Program Fee:</p>
          <div className="text-5xl md:text-6xl font-bold text-purple-400 mb-6">{vePricing.fee}</div>
          <div className="h-px bg-white/10 mb-4" />
          <div className="space-y-3 mb-6">
            <div className="flex items-center gap-2">
              <Check className="w-4 h-4 text-purple-400" />
              <span className="text-sm text-white/70">{vePricing.placement}</span>
            </div>
            <div className="flex items-center gap-2">
              <Check className="w-4 h-4 text-purple-400" />
              <span className="text-sm text-white/70">{vePricing.emi}</span>
            </div>
          </div>
          <div className="h-px bg-white/10 mb-4" />
          ...
          <div className="text-2xl font-bold text-white">{vePricing.nextCohort}</div>
        </div>

        {/* Early bird card */}
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
          <p className="text-purple-400 text-lg font-semibold italic mb-2">
