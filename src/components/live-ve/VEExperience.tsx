  ...
  <section className="py-20 md:py-28" style={{ background: "hsl(160 8% 8%)" }}>
    <div className="max-w-[1200px] mx-auto px-6 md:px-12">
      <FadeInSection className="text-center mb-14">
        <p className="text-xs text-white/40 tracking-[0.2em] uppercase mb-4" style={{ fontFamily: "'DM Sans', sans-serif" }}>🎬 What You'll Experience?</p>
        ...
        <p className="text-sm text-white/50 max-w-2xl mx-auto" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          ...
          return (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-white mb-1" style={{ fontFamily: "'DM Sans', sans-serif" }}>{exp.title}</h3>
                  <p className="text-xs text-white/50 leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>{exp.description}</p>
                </div>
              </div>
            </m.div>
          );
