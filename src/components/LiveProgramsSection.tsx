    ...
    <section
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <FadeInSection className="text-center mb-6">
          <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary font-sans-body text-[11px] tracking-[0.2em] uppercase font-semibold">LIVE MENTORSHIP COHORTS
        ...
        <FadeInSection className="text-center mb-10 md:mb-14" delay={120}>
          <p className="font-sans-body text-sm md:text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">LIVE mentorship cohorts designed for one thing : taking you from "I know about it" to "I can actually do it." With industry mentors, live feedback, real work, and placement assistance to get you where you want to be.
        ...
        <FadeInSection delay={180}>
          <div className="grid grid-cols-3 gap-4 md:gap-6 mb-14 md:mb-20 max-w-lg mx-auto">
            {stats.map((stat, i) => <div key={stat.label} className="text-center py-4 px-3 rounded-xl border border-border/50 bg-card/40">
        ...
        <FadeInSection className="mb-16 md:mb-24">
          <div className="overflow-hidden relative" aria-label="Student testimonials">
            ...
            <div className="marquee-track flex gap-6 hover:[animation-play-state:paused]">
              ...
              <div key={i} className="flex-shrink-0 w-[380px] p-6 border border-border/40 bg-card/30 min-h-[120px] flex flex-col justify-between rounded-xl">
